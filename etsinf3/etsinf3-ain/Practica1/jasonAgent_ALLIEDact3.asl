...
+!update_targets : movimiento(0)
	<-	
		!add_task(task(2000,"TASK_GOTO_POSITION",self,pos(10,0,10),""));
		-+movimiento(1);
	.
+!update_targets : movimiento(1)
	<-	
		!add_task(task(2000,"TASK_GOTO_POSITION",self,pos(10,0,230),""));
		-+movimiento(2);
	.	
+!update_targets : movimiento(2)
	<-	
		!add_task(task(2000,"TASK_GOTO_POSITION",self,pos(230,0,230),""));
		-+movimiento(3);
	.	
+!update_targets : movimiento(3)
	<-	
		!add_task(task(2000,"TASK_GOTO_POSITION",self,pos(230,0,10),""));
		-+movimiento(0);
	.	
